...
#endif
#ifndef ILI9341_SDA_PIN
#define ILI9341_SDA_PORT       GPIOA
...
#define ILI9341_SCK_SET				GPIO_SetBits(ILI9341_SCK_PORT, ILI9341_SCK_PIN)
#define ILI9341_SCK_RESET			GPIO_ResetBits(ILI9341_SCK_PORT, ILI9341_SCK_PIN)
#define ILI9341_SDA_SET				GPIO_SetBits(ILI9341_SDA_PORT, ILI9341_SDA_PIN)
#define ILI9341_SDA_RESET			GPIO_ResetBits(ILI9341_SDA_PORT, ILI9341_SDA_PIN)
...
void TM_Test2()
{
	...
	/* Init SCK/SDA pin */
	TM_GPIO_Init(ILI9341_SCK_PORT, ILI9341_SCK_PIN, TM_GPIO_Mode_OUT, TM_GPIO_OType_PP, TM_GPIO_PuPd_UP, TM_GPIO_Speed_Medium);
	TM_GPIO_Init(ILI9341_SDA_PORT, ILI9341_SDA_PIN, TM_GPIO_Mode_OUT, TM_GPIO_OType_PP, TM_GPIO_PuPd_UP, TM_GPIO_Speed_Medium);
...
#define delay() TM_ILI9341_Delay(1000)

//-----------------------------------------//
void LCD_ILI9488_CMD(unsigned char c)
 {
  unsigned char i;
...
void TM_Test3()
{
  ...
  while (1) {
    LCD_ILI9488_CMD(0xE0);
        TM_ILI9341_Delay(200000);
  }
}
void LCD_ILI9488_Parameter(unsigned char d)
{
  unsigned char i;
